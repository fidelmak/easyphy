...
class QuizScreenBio extends StatefulWidget {
  @override
  State<QuizScreenBio> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizScreenBio> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(BioData2024);
  }
