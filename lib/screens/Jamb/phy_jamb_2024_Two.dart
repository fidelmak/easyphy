...
import '../../data/jamb_physics_two_2024.dart';
import '../../phyProvider/unit_quiz_provider.dart';

// Import your model

class QuizScreenJambTwo extends StatefulWidget {
  @override
  State<QuizScreenJambTwo> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizScreenJambTwo> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(JambDataTwo2024);
  }
