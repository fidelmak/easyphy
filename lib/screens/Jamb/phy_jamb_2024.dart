...
class QuizScreenJambOne extends StatefulWidget {
  @override
  State<QuizScreenJambOne> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizScreenJambOne> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(JambDataone2024);
  }
