...
class QuizScreenEng extends StatefulWidget {
  @override
  State<QuizScreenEng> createState() => _QuizScreenEngState();
}

class _QuizScreenEngState extends State<QuizScreenEng> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(EnglishData2023);
  }
