...
import 'package:easyphy/data/biology_skeletal.dart';
...
import '../../data/bio_definition.dart';
import '../../data/biology_law.dart';
import '../../data/chem_definitions.dart';
import '../../data/chem_law.dart';
import '../../data/chem_units.dart';
import '../../data/chemistry_formula.dart';
...
class _SelectCategoryState extends State<BiologySelect> {
  int _currentPage = 0;
  ...
  final List<PracticeOption> practiceOptions = [
    ...
    PracticeOption(
      title: "Definitions",
      subtitle: "Biology Definitions",
      icon: Icons.menu_book,
      color:Colors.white ,
      textColor: nov,
      route: PracticePhyScreen(
        yourTest: 'Biology Definitions',
        yourData: BioDefinition,
      ), //QuizDefinition(),
    ),
    PracticeOption(
      title: "Skeletal System  ",
      subtitle: "The Skeletal system",
      icon: Icons.menu_book,
      color: Colors.blue,
      textColor: Colors.amber,
      route: PracticePhyScreen(
        yourTest: 'Skeletal Sytem ',
        yourData: BioSkeletal,
      ), //QuizDefinition(),
    ),
  ];
