...
class ChemSelect extends StatefulWidget {
  const ChemSelect({super.key});
...
class _SelectCategoryState extends State<ChemSelect> {
  int _currentPage = 0;
  ...
  final List<PracticeOption> practiceOptions = [
    ...
    PracticeOption(
      title: "Definitions",
      subtitle: "Chemistry Definitions",
      icon: Icons.menu_book,
      color: mama,
      textColor: nov,
      route: PracticePhyScreen(
        yourTest: 'Chemistry Definitions',
        yourData: ChemDefinition,
      ), //QuizDefinition(),
    ),
    PracticeOption(
      title: "Units ",
      subtitle: "units in chemistry and symbols",
      icon: Icons.menu_book,
      color: Colors.blue,
