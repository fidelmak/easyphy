...
class QuizDefinition extends StatefulWidget {
  @override
  State<QuizDefinition> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizDefinition> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(physicsDefinitions);
  }
