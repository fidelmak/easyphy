...
import '../../data/law.dart';
import '../../phyProvider/unit_quiz_provider.dart';

// Import your model

class QuizLaws extends StatefulWidget {
  @override
  State<QuizLaws> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizLaws> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(physicsLaws);
  }
