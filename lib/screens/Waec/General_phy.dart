...
import '../../data/waec_physics_2023.dart';
import '../../phyProvider/unit_quiz_provider.dart';

// Import your model

class QuizScreenGeneral extends StatefulWidget {
  @override
  State<QuizScreenGeneral> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QuizScreenGeneral> {
  @override
  void initState() {
    super.initState();
    ...
    quizProvider.loadQuestions(WaecData2023);
  }
